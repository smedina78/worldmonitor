...
Facts reconciled: 2026-09-13 — see Data Coverage below for how each figure is derived.
...
Coverage reconciled: 2026-09-13. Every figure below is generated from this repository's authoritative registries by `npm run build:ai-search` — the same registries that produce https://www.worldmonitor.app/sources/.
